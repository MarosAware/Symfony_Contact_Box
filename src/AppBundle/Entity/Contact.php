...
class Contact
{
    ...
    /**
     * @ORM\OneToMany(targetEntity="AppBundle\Entity\Address", mappedBy="contact", cascade={"remove"})
     */
    private $addresses;

    /**
     * @ORM\OneToMany(targetEntity="AppBundle\Entity\Phone", mappedBy="contact", cascade={"remove"})
     */
    private $phones;

    /**
     * @ORM\OneToMany(targetEntity="AppBundle\Entity\Email", mappedBy="contact", cascade={"remove"})
     */
    private $emails;
